          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nomDistrict" value="<?php echo $this->input->post('nomDistrict'); ?>" class="form-control" id="nomDistrict" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nombreTroupes" value="<?php echo $this->input->post('nombreTroupes'); ?>" class="form-control" id="nombreTroupes" />
						</div>
					</div>
					<div class="col-md-6">
