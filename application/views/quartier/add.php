    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Quartier Add</h3>
            </div>
            <?php echo form_open('quartier/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nomQuartier" value="<?php echo $this->input->post('nomQuartier'); ?>" class="form-control" id="nomQuartier" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="nomChefQuatier" class="control-label">NomChefQuatier</label>
						<div class="form-group">
							<input type="text" name="nomChefQuatier" value="<?php echo $this->input->post('nomChefQuatier'); ?>" class="form-control" id="nomChefQuatier" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="telephoneChefQuatier" class="control-label">TelephoneChefQuatier</label>
						<div class="form-group">
							<input type="text" name="telephoneChefQuatier" value="<?php echo $this->input->post('telephoneChefQuatier'); ?>" class="form-control" id="telephoneChefQuatier" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="nombreCellules" class="control-label">NombreCellules</label>
						<div class="form-group">
							<input type="text" name="nombreCellules" value="<?php echo $this->input->post('nombreCellules'); ?>" class="form-control" id="nombreCellules" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="contactBureauQuartier" class="control-label">ContactBureauQuartier</label>
						<div class="form-group">
							<input type="text" name="contactBureauQuartier" value="<?php echo $this->input->post('contactBureauQuartier'); ?>" class="form-control" id="contactBureauQuartier" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="adresseChefQuatier" class="form-control" id="adresseChefQuatier"><?php echo $this->input->post('adresseChefQuatier'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="adresseBureauQuartier" class="control-label">AdresseBureauQuartier</label>
						<div class="form-group">
							<textarea name="adresseBureauQuartier" class="form-control" id="adresseBureauQuartier"><?php echo $this->input->post('adresseBureauQuartier'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
