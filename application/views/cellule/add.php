    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Cellule Add</h3>
            </div>
            <?php echo form_open('cellule/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nomCellule" value="<?php echo $this->input->post('nomCellule'); ?>" class="form-control" id="nomCellule" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nomChefCellule" value="<?php echo $this->input->post('nomChefCellule'); ?>" class="form-control" id="nomChefCellule" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="telephoneChefCellule" class="control-label">TelephoneChefCellule</label>
						<div class="form-group">
							<input type="text" name="telephoneChefCellule" value="<?php echo $this->input->post('telephoneChefCellule'); ?>" class="form-control" id="telephoneChefCellule" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="nombreAvenues" class="control-label">NombreAvenues</label>
						<div class="form-group">
							<input type="text" name="nombreAvenues" value="<?php echo $this->input->post('nombreAvenues'); ?>" class="form-control" id="nombreAvenues" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="adresseChefCellule" class="form-control" id="adresseChefCellule"><?php echo $this->input->post('adresseChefCellule'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
